...
import (
	...
	mysql "github.com/uber/submitqueue/extension/queue/mysql"
)
...
func (s *AdminStore) GetTopicStats(ctx context.Context, topic string, dlqSuffix string) (TopicStats, error) {
	...
	// All messages are visible in the immutable log model
	stats.VisibleMessages = stats.TotalMessages
	stats.InvisibleMessages = 0
